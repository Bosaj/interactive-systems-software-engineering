...
<!-- Header Banner -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,3,5,30&height=200&section=header&text=ENIAD%20Software%20Engineering%20%26%20IHM&fontSize=32&animation=twinkling&fontAlignY=35&desc=ENIAD%20Berkane%20%7C%20Semestre%206%20Engineering%20Laboratory%20Suite&descSize=14&descAlignY=55" alt="ENIAD Software Engineering & Interactive Systems (Semestre 6) Banner" width="100%" />

<!-- Typing Animation -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&repeat=true&width=800&height=40&lines=Semestre%206%20Engineering%20Curriculum;React%20and%20React%20Native%20IHM%20Development;Software%20Engineering%20and%20UML%20Modeling;Operating%20Systems%20and%20Concurrency;Computer%20Networks%20and%20Operational%20Research" alt="Typing SVG" />
</p>

<!-- Quality & Community Badges -->
<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square" alt="MIT License" /></a>
  <a href="https://github.com/Bosaj/eniad-software-engineering-ihm/actions"><img src="https://img.shields.io/badge/CI%20Pipeline-Passing-brightgreen?style=flat-square&logo=githubactions" alt="CI Status" /></a>
  <a href="https://github.com/Bosaj/eniad-software-engineering-ihm/stargazers"><img src="https://img.shields.io/github/stars/Bosaj/eniad-software-engineering-ihm?style=flat-square&logo=github&color=00d9ff" alt="Stars" /></a>
...
```mermaid
graph TD
    subgraph S6_Curriculum [Semestre 6 Engineering Curriculum - CI1 Spring]
        IHM[Développement d'IHM - React & React Native]
        GL[Génie Logiciel - UML & Design Patterns]
        SE[Systèmes d'Exploitation - Concurrency & Processes]
        NET[Réseaux Informatiques - OSI, TCP/IP & Sockets]
        RO[Recherche Opérationnelle - Optimization & Simplex]
        COMP[Compilation - Lexical & Syntax Analysis]
        STAT[Statistiques & Probabilités Appliquées]
    end
    IHM --> SENG[Advanced Software Engineering & Systems Integration]
    GL --> SENG
    SE --> SENG
    NET --> SENG
    RO --> SENG
    COMP --> SENG
    STAT --> SENG
    style S6_Curriculum fill:#0F172A,stroke:#00D9FF,stroke-width:2px,color:#fff
    style SENG fill:#7928CA,stroke:#fff,stroke-width:2px,color:#fff
...
- **GitHub Wiki**: [https://github.com/Bosaj/eniad-software-engineering-ihm/wiki](https://github.com/Bosaj/eniad-software-engineering-ihm/wiki)
